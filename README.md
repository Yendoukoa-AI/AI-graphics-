...
## 📢 Latest News: Super Release v1.4.0 is Here!

We are excited to announce our super release! **Global DesignAI Studio v1.4.0** is now live with enhanced authentication, fully fixed E2E test suites, and unified global branding.

- **View on GitHub Session**: [v1.4.0](https://github.com/GYFX35/AI-graphics-/releases/tag/v1.4.0)
- **Artifact**: [Download release-v1.4.0.tar.gz](https://github.com/GYFX35/AI-graphics-/releases/download/v1.4.0/release-v1.4.0.tar.gz)
...
- **Fixed E2E Test Suite**: Re-implemented and fully green Playwright and Vitest test suites.
- **Custom Verification Tools**: Added an automated python suite for running system checks and verifications.
- **Global Branding & i18n**: Consistent global studio branding across all international translations.
...
- **[Download v1.4.0 Artifact](https://github.com/GYFX35/AI-graphics-/releases/download/v1.4.0/release-v1.4.0.tar.gz)**
...
```
This will generate:
- `release-v1.4.0.tar.gz`: The production-ready bundle.
- `release-v1.4.0.tar.gz.sha256`: A checksum file to verify the artifact.

### Verifying Integrity
To protect against unauthorized modifications, always verify the integrity of the downloaded artifact:
```bash
python3 scripts/verify_integrity.py release-v1.4.0.tar.gz
```
